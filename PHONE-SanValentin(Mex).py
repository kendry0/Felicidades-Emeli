...
def mostrar_contador_y_mensaje(t):
    ...
    contador.write("Feliz Cumpleaños Emeli PD no te soporto", align="center", font=("Courier", tamaño_fuente//2, "bold"))
    time.sleep(2)
    contador.clear()
...
def write_14():
    contador.goto(0,200)
    contador.write("¡Feliz Cumpleaños Emeli PD no te soporto <3 !", align="center", font=("Courier", 25 //2, "bold"))
    time.sleep(1)
