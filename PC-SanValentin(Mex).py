...
def mostrar_contador_y_mensaje(t):
    ...
    contador.write("¡Feliz Cumpleaños PD No te soporto<3", align="center", font=("Courier", tamaño_fuente//2, "bold"))
    time.sleep(2)
    contador.clear()
...
def write_14():
    contador.goto(0,200)
    contador.write("¡Feliz Cumpleaños !", align="center", font=("Courier", 55 //2, "bold"))
    time.sleep(1)
